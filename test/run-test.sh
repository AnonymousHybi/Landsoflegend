...
function run_code_tests {
    ...
    run_test "check tags" "python2 test/TagMatcher/tag-matcher.py ."
    run_test "check punctuation" "python2 test/PunctuationChecker/punctuation-checker.py ."
...
function run_byond_tests {
    ...
    run_test "check globals unchanged" "md5sum -c - <<< 'a3ae321e7ebfd7c58a24b14b7e83ca57 *code/_helpers/global_access.dm'"
